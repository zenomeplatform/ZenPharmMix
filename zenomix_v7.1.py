...
neuroleptics_df_4 = neuroleptics_df_4.rename(columns={"Guideline": "Методические рекомендации"})

#Apply color
neuroleptics_colored = neuroleptics_df_4.style.apply(color_col,
...
antidepressants_df_4 = antidepressants_df_4.rename(columns={"Guideline": "Методические рекомендации"})

#Apply color
antidepressants_colored = antidepressants_df_4.style.apply(color_col,
                                                   pattern_map={'Медленный метаболизатор': '#FF0000',
                                                                'Промежуточный метаболизатор': '#FFFF00',
                                                                'Нормальный метаболизатор': '#00B050',
                                                                'Ультрабыстрый метаболизатор': '#00B0F0',
...
anticonvulsants_df_4 = anticonvulsants_df_4.rename(columns={"Guideline": "Методические рекомендации"})

#Apply color
anticonvulsants_colored = anticonvulsants_df_4.style.apply(color_col,
                                                   pattern_map={'Медленный метаболизатор': '#FF0000',
                                                                'Промежуточный метаболизатор': '#FFFF00',
                                                                'Нормальный метаболизатор': '#00B050',
                                                                'Ультрабыстрый метаболизатор': '#00B0F0',
...
tranquilizers_df_4 = tranquilizers_df_4.rename(columns={"Guideline": "Методические рекомендации"})

#Apply color
tranquilizers_colored = tranquilizers_df_4.style.apply(color_col,
                                                   pattern_map={'Медленный метаболизатор': '#FF0000',
                                                                'Промежуточный метаболизатор': '#FFFF00',
                                                                'Нормальный метаболизатор': '#00B050',
                                                                'Ультрабыстрый метаболизатор': '#00B0F0',
...
nootropic_stimulants_df_4 = nootropic_stimulants_df_4.rename(columns={"Guideline": "Методические рекомендации"})

#Apply color
nootropic_stimulants_colored = nootropic_stimulants_df_4.style.apply(color_col,
                                                   pattern_map={'Медленный метаболизатор': '#FF0000',
                                                                'Промежуточный метаболизатор': '#FFFF00',
                                                                'Нормальный метаболизатор': '#00B050',
                                                                'Ультрабыстрый метаболизатор': '#00B0F0',
...
##Combine all results
shutil.copy(script_path + 'Risk_alleles.xlsx', sys.argv[2])

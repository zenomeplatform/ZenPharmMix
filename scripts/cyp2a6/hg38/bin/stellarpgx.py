...
cov_ex1_ex4 = get_total_CN(cov_file)[6]
cov_ex5_ex9 = get_total_CN(cov_file)[7]
cov_ex3_ex4 = get_total_CN(cov_file)[8]
cov_ex9_3pr = get_total_CN(cov_file)[9]
cov_ex7_ex8 = get_total_CN(cov_file)[10]

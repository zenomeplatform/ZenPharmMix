...
if snv_def_calls == None and "*139/*4x2" in bac_alleles:
    snv_def_calls = [['1.v1_4.v11'], '1.v1_4.v11', '*1/*4x2']
...
if cn == '2' and snv_def_alleles == '*4/*4':
    ...
    if 'or' in snv_def_alleles:
        ...
        if snv_def_alleles[0] == '*4' or snv_def_alleles[1] == '*4':
            def_1 = snv_def_alleles[0]
            def_2 = snv_def_alleles[1]
            ind_star2 = snv_def_alleles.index('*4')
            ind_other = 1 - ind_star2

            test_68 = hybrid_test_68(cn, av_cov, cn_in1_3pr, cov_2d7_hyb, in_list)
        ...
        elif snv_def_alleles[0] == '*2' or snv_def_alleles[1] == '*2':
